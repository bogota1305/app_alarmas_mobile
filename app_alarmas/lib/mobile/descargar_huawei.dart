...
class DownloadHuawei extends StatefulWidget {
  @override
  State<DownloadHuawei> createState() => _DownloadHuaweiState();
}

class _DownloadHuaweiState extends State<DownloadHuawei> {
  @override
                ...
                child: Container(
                  ...
                  child: Center(
                    child: SizedBox(
                      ...
                      height: 87,
                      child: Image.asset(
                        'assets/mobile/images/image-8.png',
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),

...
class DownloadApple extends StatefulWidget {
  @override
  State<DownloadApple> createState() => _DownloadAppleState();
}

class _DownloadAppleState extends State<DownloadApple> {
  @override
                ...
                child: Container(
                  ...
                  child: Center(
                    child: SizedBox(
                      ...
                      height: 87,
                      child: Image.asset(
                        'assets/mobile/images/image-6.png',
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
